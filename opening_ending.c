...
int main()
{
	...
	if(root == 1)
	{
		printf("그대로 행복하게 로X트 아크를 즐기는 거야.\n");
	}
	if(root == 2)
	{
	...
	if(root == 1)
	{
		printf("로X트 아크를 하기 위해서 빨리 문제지를 다 풀고 집에 돌아가야 합니다!\n");
	}
	if(root == 2)
	{
	...
	if(root == 1)
	{
		printf("로X트 아크에 접속하실수 있기를 바라겠습니다.\n");
	}
	if(root == 2)
	{
